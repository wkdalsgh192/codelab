...
import com.mino.springlab.lecture6.ProcessingErrorHandler;
...
//    }
    ...
    public ProcessingErrorHandler errorHandler() {
        return new ProcessingErrorHandler("x.guideline.dead");
    }

    @Bean
    public PictureImageConsumer pictureImageConsumer() {
        return new PictureImageConsumer();
    }

    @Bean
    public PictureVectorConsumer pictureVectorConsumer() {
        return new PictureVectorConsumer();
    }
