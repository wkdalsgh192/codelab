...
//    }
    ...
    @Bean
    public EmployeeProducer producer() {
        return new EmployeeProducer();
    }

    @Bean
    public ProcessingErrorHandler errorHandler() {
        return new ProcessingErrorHandler("x.guideline2.dead");
    }

    @Bean
    public MarketingConsumer marketingConsumer() {
        return new MarketingConsumer();
    }

    @Bean
    public AccountingConsumer accountingConsumer(ProcessingErrorHandler errorHandler) {
        return new AccountingConsumer(errorHandler);
    }
}
